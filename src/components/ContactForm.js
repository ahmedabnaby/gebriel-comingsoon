                    ...
                    <div className="card-body  trial">
                        ...
                        <form id="contact-form" role="form" onSubmit={sendEmail}>
                            ...
                            <div className="row">
                                ...
                                <div className="form-group"> <label htmlFor="form_name">Name*</label> <input id="form_name" type="text" required name="name" className="form-control" placeholder="Name" data-error="Firstname is required." /> </div>
                                </div>
                                {/* <div className="col-md-6">
